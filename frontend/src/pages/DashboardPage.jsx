...
const DashboardPage = () => {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const [bookingsRes, receivedRes, productsRes, servicesRes, favoritesRes] = await Promise.all([
  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-extrabold text-text mb-1">Dashboard</h1>
        <p className="text-sm text-muted mb-6">Welcome back, {user?.fullName}</p>
