    ...
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-text mb-1">Create your account</h1>
          <p className="text-muted mb-8">Join your local marketplace community</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              <label className="block text-xs font-semibold text-muted uppercase tracking-wide mb-2">Password</label>
